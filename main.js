...
// @version      1.0.1
// @description  A Hacked Client For Shell Shockers
// @author       COHEJH
// @match        *://shellshock.io/*
// @match        *://algebra.best/*
// @match        *://algebra.vip/*
...
// @match        *://yolk.today/*
// @match        *://zygote.cafe/*
// @icon         https://cohejh.com/seo-home1.png
// @grant        none
...
<div class="info">${shouldShowAd ? `<big>Loading ad...</big>` : `<div class="close-icon" onclick="this.parentNode.style.display='none';"></div>
                <big>== COHEJH Client v1.0.1 ==</big>
                <br>
    <hr/>
        Client Modules:
                <div class="btn" style="margin: 5px 0px 5px 0px;" onclick="window.open('https://classroom.google.com/', '_blank')">[X] Credits</div>
        <div class="btn" id="menubutton" style="margin: 5px 0px 5px 0px;">[H] Toggle Panel</div>
...
document.addEventListener('keydown', (event) => {
    if (event.key === 'x') {
      window.location.replace("https://cohejh.com");
    }
})
